package com.sxmh.wt.lotterysystem.download;
...
public class DownLoadManager {
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        File file = new File(Constants.APP_PATH, fileName);
        if (file.exists()) {
        ...
        while (downloadLength >= contentLength) {
            ...
            File newFile = new File(Constants.APP_PATH, fileNameOther);
            file = newFile;
    ...
    private class DownloadSubscribe implements ObservableOnSubscribe<DownloadInfo> {
        ...
        public void subscribe(ObservableEmitter<DownloadInfo> e) throws Exception {
            ...
            File file = new File(Constants.APP_PATH, downloadInfo.getFileName());
            InputStream is = null;
