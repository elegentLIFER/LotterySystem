package com.sxmh.wt.lotterysystem.printer;
...
public class DeviceConnFactoryManager {
    ...
    public static final String ACTION_HH = "actionh";
                    ...
                    if (sendCommand == esc) {
                        ...
                        if (currentPrinterCommand == null) {
                            ...
                            if (result == 0) {//打印机状态查询
                                ...
                                boolean canPrint = (buffer[0] & ESC_STATE_PAPER_ERR) <= 0 && (buffer[0] & ESC_STATE_COVER_OPEN) <= 0 && (buffer[0] & ESC_STATE_ERR_OCCURS) <= 0;
                                Intent intent = new Intent(ACTION_HH);
                                intent.putExtra(ACTION_HH, canPrint);
                                MyApplication.getInstance().sendBroadcast(intent);
                            }
                        }
